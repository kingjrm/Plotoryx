...
<head>
    ...
    <title>Plotoryx - Verify Email</title>
...
<body class="bg-gradient-custom min-h-screen flex items-center justify-center p-4">
    <div class="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md transform transition-all duration-300 hover:scale-105">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-600 mt-2">Enter the 6-digit code sent to <?php echo htmlspecialchars($email); ?></p>
        </div>
        ...
        <form action="verify.php?email=<?php echo urlencode($email); ?>" method="POST" class="space-y-6">
            <div>
        ...
        <form action="verify.php?email=<?php echo urlencode($email); ?>" method="POST" class="mt-4">
